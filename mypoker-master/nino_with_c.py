...
class RTPlayer(BasePokerPlayer):
    ...
    def receive_round_result_message(self, winners, hand_info, round_state):
        ...
        opp_last_record = self.stack_record[opp_id][0]
        ...
        # learn from opponent's behaviour if there is showdown
        if len(hand_info) != 0:
            opp_hole = hand_info[opp_id]['hand']['hole']
        ...
        self.pp.pprint(round_state['action_histories'])
